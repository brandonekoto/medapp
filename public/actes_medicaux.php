...
if (isset($_GET['action'])) {//
    switch ($_GET['action']) {
        case "add":
            $filariane = array(
                ...
                'Création du nouvel acte' => "/public/actes_medicaux.php?action=add",
                'Initialisation' => ""
            );
            $titlePage = "Initialisation du nouvel acte";
            break;
        case "view" :
            $filariane = array(
                'Actes médicaux' => "/public/actes_medicaux.php",
    ...
    $titlePage = "Liste des actes medicaux";
}
        ...
        <div class="inner bg-light lter">
            <div class="main-bar">
                ...
                <div class="box-options">
                    <a href="/public/actes_medicaux.php?action=add&etape=0" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> </a>
                                            ...
                                            <div id="rootwizard">
                                                    ...
                                                    <div class="navbar-inner">
                                                        <div class="container">
                                                            <ul class="nav nav-tabs" style="padding-left: 50px">
                                                                ...
                                                                <li class=""><a href="#tab2" data-toggle="tab">Prélèvement S. Vitaux</a></li>                                                                
                                                            </ul>
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="tab1">
                                                        <form class="form-horizontal" role="form" id="formInitActe" action="/controls/control.php?mod=acte&act=init" method="POST" autocomplete="off">
                                                            <div class="alert alert-info alert-error">
                                                                <h3>Bienvenue à l'initiation du processus médical</h3>
                                                                <p>Tout acte poser sur un patient doit être initialiser</p>
                                                                <p>Notez bien que le patient doit être enregstré d'abord c'est à dire créer d'abord la fiche du patient</p>
                                                                <p>Pour initialiser vous devriez choisir sur la liste Acte médical un acte que vous vouliez procéder puis vous choisissez le patient</p>

                                                                <p>La cherche du patient se fait sur la zone labeliser Patient, <br>Il y a 4 façons de rechercher un patient, Soit par nom, soit prenom, soit postnom et enfin par son numero carte</p>
                                                            </div>
                                                                            ...
                                                                            foreach ($listActes as $key => $itemActe) {
                                                                                ...
                                                                                if ($cle !== $itemActe->id_cat) {
                                                                                    ...
                                                                                    <optgroup label="<?= $itemActe->category ?>" data-category_acte='<?= $itemActe->id_cat ?>'>
                                                                                        <option value="<?= $itemActe->id ?>" data-category_acte='<?= $itemActe->id_cat ?>' data-id='<?= $itemActe->id ?>' ><?= $itemActe->acte . " (Privé" . $itemActe->prix_prive . "$) &harr; (" . $itemActe->prix_prive * $_SESSION['TAUX'] . "CDF)" ?></option>
                                                    ...
                                                    <div class="tab-pane" id="tab2">
                                                        <form class="form-horizontal" role="form" id="formConsultation" method="POST" action="/controls/control.php?mod=acte&act=addconsultationinfo" autocomplete="off">
                                                            <div class="alert alert-info alert-error">
                                                                <h3>Bienvenue à l'enregistrement des informations de signe vitaux</h3>
                                                                <p>Etant donné une consultation est considérée comme un acte, vous devriez saisir la référence de l'acte initialisé pour cet patient pour enregistrer ses signes vitaux</p>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <textarea class="form-control" placeholder="Ecrire votre observation si il n'y en a" name="anamnse" rows="3"><?= (isset($anamnese) ? $anamnese : "") ?></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                        ...
                        case "view" :
                            ...
                            case "hospitalisation":
                                ...
                                if (isset($_GET["m"]) && $_GET['m']== "view") {
                                        ...
                                        if (isset($_GET['id']) && !empty($_GET['id'])) { //@ $id de la acte medicaux  
                                    unset($condition);
                                    $seeActe = $controller->getlistacte(['id'=>$_GET['acte']]);
                                    $listChambre = $controller->getchambre();
                                    $listLits = $controller->getlits();
                                                    ...
                                                    <div class="panel panel-primary panel-group">
                                                        ...
                                                        <div class="panel-body">                                            
                                                            ...
                                                            if (count($hospi) > 0) {
                                                                ...
                                                                ?>
                                                                    <div class="line-personne-info"><span class="champ">Destination</span><span class="val-line-personne-info"><?= isset($hospi[0]->destination ) ? $hospi[0]->destination  : "" ?></span></div>
                                                                <div class="line-personne-info"><span class="champ">&nbsp;</span><span class="val-line-personne-info">
                                                                        <div class="input-group">
                                                                            <?php
                                                                            if ($hospi[0]->statuthosp == 0) {
                                        ...
                                        <div class="text-center">
                                                        <ul class="stats_box">
                                                            <li>
                                                                ...
                                                                <div class="stat_text">
                                                                    <strong><?=  (isset($plife)) ? count($plife) : "0" ?></strong>Hospitalisé(e)s
                                                            ...
                                                            <li>
                                                                ...
                                                                ?>
                                                                <div class="stat_text">
                                                                    <strong><?=  (isset($pdie)) ? count($pdie) : "0" ?></strong>Libéré(e)s
                                                            ...
                                                            <li>
                                                                ...
                                                                ?>
                                                                <div class="stat_text">
                                                                    <strong><?=  (isset($pdie)) ? count($pdie) : "0" ?></strong>Transféré(e)s
                                                                    <span class="percent up"> <i class="fa fa-caret-up"></i> </span>
                                                                </div>
                                                            </li>  
                                                        </ul>
                                                    ...
                                                    <div class="box">
                                                        ...
                                                        <div class="body" id="trigo" style="height: auto;">
                                                            ...
                                                            if (isset($listHospitalises['results']) && count($listHospitalises['results']) > 0) {
                                                                //\composants\Utilitaire::debug($listHospitalises);
                                                                $count = 0;
                                                                ?>
                                                                <div class="col-lg-12">
                                                                            ...
                                                                            foreach ($listHospitalises['results'] as $hospitalise) {
                                                                                ...
                                                                                <tr class="">
                                                                                    ...
                                                                                    <td><?php
                                                                                        ...
                                                                                        if($hospitalise->statuthosp == 0){
                                                                                            echo 'Hospitalisé(e)';
                                                                                        }elseif ($hospitalise->statuthosp == 1) {
                                                                                                                echo "Libéré(e)";
                                                                                                            }else{
                                                                                                                echo 'Transféré(e)';
                                                                                                            }
                                                                                    ...
                                                                                    <td><?= (new \DateTime($hospitalise->date_entree))->diff(new \DateTime(($hospitalise->date_sortie) ? $hospitalise->date_sortie : "now"))->days  ?></td>
                                                                                    <td><?= $hospitalise->prixchambre * (new \DateTime($hospitalise->date_entree))->diff(new \DateTime(($hospitalise->date_sortie) ? $hospitalise->date_sortie : ""))->days ?> $</td>
                                                                                    <td>                                                                                
                                                                                        <a href="/public/actes_medicaux.php?action=hospitalisation&m=view&id=<?= $hospitalise->idhospitalisation ?>&acte=<?= $hospitalise->id_actepose ?>" class="text-success"><span class="glyphicon glyphicon-eye-open"></span></a>
                        ...
                        <div class="text-center">
                            <ul class="stats_box">
                                ...
                                <li>
                                    <div class="sparkline line_day"></div>
                                    <div class="stat_text">
                                        <strong>0</strong>en voix de sortie
                                ...
                                <li>
                                    ...
                                    <div class="stat_text">
                                        <strong>0</strong>en état critique
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="box">
                                    ...
                                    <div id="" class="body">
                                        <?php $actes = $controller->getlistacte(); ?>
                                        <div class="col-lg-12">
                                                ...
                                                <tbody>
                                                    ...
                                                    if (count($actes['results']) > 0) {
                                                        ...
                                                        foreach ($actes['results'] as $item) {
                                                            ...
                                                            <tr class="">
                                                                <td><?= $count ?></td>
                                                                <td><?= $item->idactepose ?></td>
                                                                <td>
                                                                    <a href="/public/actes_medicaux.php?action=view&id=<?= $item->idPatient ?>"><img src="/img/personnel/<?= $item->filename . "." . $item->type ?>" class="user-profile">
                                                                        <h5><?= $item->nompatient . " " . $item->postnompatient . " " . $item->prenompatient ?></h5></a>
                                                                </td>
                                                                ...
                                                                <td><?= Helpers\Date::dateToFr($item->date) ?></td>
                                                                <td>
                                                                    <a href="/public/actes_medicaux.php?action=view&id=<?= $item->idactepose ?>"><span class="glyphicon glyphicon-eye-open"></span></a>                                                        
                                                                    <a href="/public/print.php?id=<?= $item->idactepose ?>" class="text-success printbtn"><i class="glyphicon glyphicon-print"></i></a>
                                                                    <a href="/controls/control.php?mod=acte&act=delacte&id=<?= $item->idactepose ?>" class="danger text-danger"><span class="glyphicon glyphicon-remove"></span></a></td>
