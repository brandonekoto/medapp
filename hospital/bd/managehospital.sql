...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 26 avr. 2019 à 10:45
...
--
-- RELATIONS POUR LA TABLE `acte_pose`:
--   `id_acte`
--       `acte` -> `id`
--   `id_agent`
--       `agent` -> `id`
...
(6, 13, 4, 15, 1, '2019-04-25 15:52:12', '0'),
(7, 1, 1, 15, 1, '2019-04-25 17:07:35', '0'),
(8, 7, 1, 15, 1, '2019-04-26 00:11:55', '0'),
(9, 1, 1, 15, 1, '2019-04-26 00:41:09', '0'),
(10, 9, 11, 15, 1, '2019-04-26 00:43:25', '0');
...
--
-- RELATIONS POUR LA TABLE `agent_family`:
--
...
--
-- RELATIONS POUR LA TABLE `agent_horaire`:
--   `idAgent`
--       `agent` -> `id`
--   `idHoraire`
--       `horaire` -> `idHoraire`
...
--
-- RELATIONS POUR LA TABLE `category_acte`:
--
...
--
-- RELATIONS POUR LA TABLE `consultation`:
--   `id_acte`
--       `acte_pose` -> `id`
--   `id_patient`
--       `patient` -> `idPatient`
...
INSERT INTO `consultation` (`id`, `id_patient`, `id_acte`, `anamnese`, `taille`, `poids`, `temp`, `obs`, `date`, `tension`) VALUES
(17, 3, 1, 'qrtr', 4, 3, 5, NULL, '2019-04-25 00:02:30', '7'),
(18, 3, 1, 'qrtr', 4, 3, 5, NULL, '2019-04-25 00:06:56', '7');
...
--
-- RELATIONS POUR LA TABLE `diagnostic`:
--   `id_acte`
--       `acte_pose` -> `id`
--
...
--
-- RELATIONS POUR LA TABLE `download`:
--
...
--
-- RELATIONS POUR LA TABLE `echproduit`:
--   `idCategorie`
...
CREATE TABLE `examen_recommand` (
  ...
  `fait` varchar(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- RELATIONS POUR LA TABLE `examen_recommand`:
--
...
--
-- RELATIONS POUR LA TABLE `facture`:
--
...
--
-- RELATIONS POUR LA TABLE `facture_produit`:
--   `idProduit`
--       `produit` -> `idProduit`
--   `idFacture`
--       `facture` -> `numRef`
...
--
-- RELATIONS POUR LA TABLE `fonction`:
--
...
--
-- RELATIONS POUR LA TABLE `horaire`:
--
...
--
-- RELATIONS POUR LA TABLE `hospitalisation`:
--
...
--
-- RELATIONS POUR LA TABLE `lot_produit`:
--   `idLot`
--       `lot` -> `idLot`
--   `idProduit`
--       `produit` -> `idProduit`
...
(11, 'Brandon', 'Ekoto', 'Brandon', 'F', '2019-04-20', 'm', 'Kinshasa', '+243822385571', 'djbrandon.ekoto@gmail.com', 'hGkeukf', '0', 0, '2019-04-24 17:57:16', 'CD', 1),
...
--
-- RELATIONS POUR LA TABLE `personne_affilie`:
--
...
CREATE TABLE `prescription` (
  `id` int(11) NOT NULL,
  `datePrescrip` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `idActe` int(11) NOT NULL,
  `observation` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- RELATIONS POUR LA TABLE `prescription`:
--
...
--
-- RELATIONS POUR LA TABLE `presence`:
--
...
--
-- RELATIONS POUR LA TABLE `structureaffilier`:
--
...
--
-- RELATIONS POUR LA TABLE `traitement_administre`:
--
...
--
-- RELATIONS POUR LA TABLE `used_element_for_treatement`:
--
...
ALTER TABLE `consultation`
  ...
  ADD CONSTRAINT `consultation_ibfk_2` FOREIGN KEY (`id_patient`) REFERENCES `patient` (`idPatient`);
