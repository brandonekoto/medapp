            ...
            try{
                ...
                if(isset($_GET['act']) && !empty($_GET['act'])){
                    ...
                    if(method_exists($mod, $action)){              
                        ...
                        new \composants\MDEException("cette page n'existe pas, soit elle a été déplacée ou supprimée", 401);               
                    }
                }else{
                    new \composants\MDEException("Aucune action ou page n'a été sélectionnée. Si l'erreur persiste prière de contacter l'administrateur du système", 401);  
                }
